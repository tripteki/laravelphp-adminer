...
use Tripteki\Adminer\Http\Requests\Settings\SettingUpdateValidation;
use Tripteki\Adminer\Http\Requests\Settings\SettingDestroyValidation;
...
class SettingController extends Controller
{
     ...
     * )
     *
     * @param \Tripteki\Adminer\Http\Requests\Settings\SettingUpdateValidation $request
     * @param string $key
     * @return \Illuminate\Http\JsonResponse
     */
     ...
     * )
     *
     * @param \Tripteki\Adminer\Http\Requests\Settings\SettingDestroyValidation $request
     * @param string $key
     * @return \Illuminate\Http\JsonResponse
     */
