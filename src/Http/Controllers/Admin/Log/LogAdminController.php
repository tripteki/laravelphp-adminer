...
namespace Tripteki\Adminer\Http\Controllers\Admin\Log;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Http\JsonResponse;
use Tripteki\Log\Contracts\Repository\Admin\ILogRepository;
use Tripteki\Adminer\Http\Requests\Admin\Logs\LogShowValidation;
...
class LogAdminController extends Controller
{
     ...
     * )
     *
     * @param \Tripteki\Adminer\Http\Requests\Admin\Logs\LogShowValidation $request
     * @param string $log
     * @return \Illuminate\Http\JsonResponse
     */
