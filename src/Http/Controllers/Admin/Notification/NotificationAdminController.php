...
namespace Tripteki\Adminer\Http\Controllers\Admin\Notification;

use Illuminate\Http\Request;
use Illuminate\Http\Response;
use Illuminate\Http\JsonResponse;
use Tripteki\Notification\Contracts\Repository\Admin\INotificationRepository;
use Tripteki\Adminer\Http\Requests\Admin\Notifications\NotificationShowValidation;
...
class NotificationAdminController extends Controller
{
     ...
     * )
     *
     * @param \Tripteki\Adminer\Http\Requests\Admin\Notifications\NotificationShowValidation $request
